...
function Adicionar({onAdicionar}){
    ...
    const handleChange = (e) =>{
        ...
        setNovoEvento({...novoEvento, [name]:value});//cria um novo evento
    }

    const handleToggleExpanded = (e) =>{
        e.stopPropagation();
        setExpanded(!expanded)
    }//pra quando tiver expandido dimiuir e quando tiver diminuido expandir
    ...
    return(
        <div className="adicionar p-3 rounded border border-white" style={{backgroundColor: '#e9ecef', color:'#212529'}}>
            ...
            <Form onSubmit={handleSubmit}>
               ...
               {/* isso aqui faz aquela parte de expandir */}
                    <div>
                        <div>
